...
elements.forEach(function (item, i){
  ...
  TweenMax.to(item, 5 + 5 * Math.random(), {x: Math.random(), y: Math.random(), rotation: Math.random()< .5? '+=360' : '-=360', repeat: -1, ease: Linear.easeNone, height: 180 + Math.random(), yoyo: true, force3D:false}, .25)
})
});
